...
This repository contains the conceptual definition and theoretical framework for **Cursor Terminal LIVE**, 
...
├── LICENSE             # CC BY 4.0
├── paper/
│   └── cursor-terminal-live.tex    # LaTeX dissertation
├── whitepaper/
│   └── cursor-terminal-live.md     # White paper
└── translations/
    ├── de/             # German
    ├── en/             # English
    ├── tr/             # Turkish
...
```bibtex
@misc{vega2025cursorterminallive,
  author = {Vega, Adam Eren},
  title = {Cursor Terminal LIVE: A Conceptual Framework},
  year = {2025},
  publisher = {GitHub},
  url = {https://github.com/vegafoundation/cursor-terminal-live}
}
```
